...
data_dir <- "/netscratch/dep_psl/grp_psl/ThomasN/ryosuke_temp/R_Fig 1f/"

dat <- read.table(paste(data_dir, "R_Fig 1f.csv", sep=""), sep=",", header=T, stringsAsFactors=F)
...
sort <- c("S150", "S0", "4MTB", "SIN", "PhE", "I3G")
