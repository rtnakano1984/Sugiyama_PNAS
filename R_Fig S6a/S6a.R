...
data_dir <- "/netscratch/dep_psl/grp_psl/ThomasN/ryosuke_temp/R_Fig S6a/"

dat_all <- read.table(paste(data_dir, "R_Fig S6a.csv", sep=""), sep=",", header=T, stringsAsFactors=F)
...
time <- c("00h", "03h", "09h", "24h", "33h", "48h")
